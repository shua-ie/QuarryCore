...
from quarrycore.protocols import CrawlResult, HardwareCapabilities, HardwareType
...
<head>
    ...
    <meta name="description" content="A comprehensive guide to machine learning algorithms">  # noqa: E501
...
class TestSocialMetricsExtractor:
    ...
    async def test_extract_share_counts(self, extractor):
        ...
        html_with_counts = SAMPLE_HTML.replace('data-share-count="42"', 'data-share-count="42"')
