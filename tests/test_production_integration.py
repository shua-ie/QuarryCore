...
from quarrycore.security.rate_limiter import RedisRateLimiter, RateLimitResult
...
class TestProductionIntegration:
    ...
    async def test_pipeline_real_processing(self):
        ...
        with patch.object(container, 'get_quality') as mock_quality, \
            ...
            mock_quality_instance.assess_quality.return_value = QualityScore(
                overall_score=0.8,
                confidence=0.9
            )
