...
from typing import Any, Dict, List, Optional, Set, Tuple, TYPE_CHECKING, Pattern
...
class AuthorExtractor:
            ...
            for i, pattern in enumerate(self.compiled_patterns):
                ...
                for match in matches:
                    ...
                    if self._is_valid_author_name(author_name):
                        ...
                        authors.append(AuthorInfo(
                            name=author_name,
                            confidence=AuthorConfidence.MEDIUM if confidence_score > 0.5 else AuthorConfidence.LOW,
    ...
    def _is_valid_author_name(self, name: str) -> bool:
        ...
        common_words = {
            'admin', 'administrator', 'author', 'editor', 'writer', 'staff',
            'team', 'news', 'press', 'media', 'content', 'article', 'post',
            'blog', 'website', 'page', 'home', 'about', 'contact', 'privacy',
        }
    ...
    def _calculate_ner_confidence(self, entity: Any, doc: Any) -> float:
        ...
        if sentence:
            ...
            author_indicators = ['by', 'author', 'written', 'posted', 'says', 'reports', 'writes']
    ...
    def _normalize_name(self, name: str) -> str:
        ...
        prefixes = ['by ', 'author ', 'dr ', 'mr ', 'ms ', 'mrs ', 'prof ', 'professor ']
        for prefix in prefixes:
        ...
        suffixes = [
            'phd', 'ph.d', 'md', 'm.d', 'jr', 'sr', 'ii', 'iii', 'iv',
            'phd in computer science', 'phd in data science', 'phd in ai',
